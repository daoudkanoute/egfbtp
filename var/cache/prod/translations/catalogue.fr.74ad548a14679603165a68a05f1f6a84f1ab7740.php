...
$catalogue = new MessageCatalogue('fr', array (
  ...
  array (
    ...
    'registration.check_email' => 'Un e-mail a été envoyé à l\'adresse %email%. Il contient un lien d\'activation sur lequel il vous faudra cliquer afin de valider votre email.',
    'registration.confirmed' => 'Félicitations, votre email est maintenant valider, l\'administration va proceder a la validation votre compte.',
    'registration.back' => 'Retour à la page login.',
    'registration.submit' => 'Créer un compte',
    'registration.flash.user_created' => 'L\'utilisateur a été créé avec succès.',
    'registration.email.subject' => 'Bienvenue !',
    'registration.email.message' => 'Bonjour !
