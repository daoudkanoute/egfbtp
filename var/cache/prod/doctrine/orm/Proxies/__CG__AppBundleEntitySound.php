 ...
 */
class Sound extends \AppBundle\Entity\Sound implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Sound' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Sound' . "\0" . 'originalName', '' . "\0" . 'AppBundle\\Entity\\Sound' . "\0" . 'path', '' . "\0" . 'AppBundle\\Entity\\Sound' . "\0" . 'isConverted', '' . "\0" . 'AppBundle\\Entity\\Sound' . "\0" . 'file', '' . "\0" . 'AppBundle\\Entity\\Sound' . "\0" . 'duration', '' . "\0" . 'AppBundle\\Entity\\Sound' . "\0" . 'title'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Sound $proxy) {
    ...
    public function setIsConverted($isConverted)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIsConverted', [$isConverted]);

        return parent::setIsConverted($isConverted);
    }
    ...
    public function getIsConverted()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIsConverted', []);

        return parent::getIsConverted();
    }
