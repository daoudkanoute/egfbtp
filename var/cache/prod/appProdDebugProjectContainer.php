...
class appProdDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'app.apprenant.code' => 'getApp_Apprenant_CodeService',
            'app.form.qcm_exam' => 'getApp_Form_QcmExamService',
            'app.form.type.choices_images' => 'getApp_Form_Type_ChoicesImagesService',
            'app.services.qcm' => 'getApp_Services_QcmService',
            ...
            'oneup_uploader.controller.attestations' => 'getOneupUploader_Controller_AttestationsService',
            'oneup_uploader.controller.images' => 'getOneupUploader_Controller_ImagesService',
            'oneup_uploader.controller.sounds' => 'getOneupUploader_Controller_SoundsService',
            ...
            'oneup_uploader.storage.attestations' => 'getOneupUploader_Storage_AttestationsService',
            'oneup_uploader.storage.images' => 'getOneupUploader_Storage_ImagesService',
            'oneup_uploader.storage.sounds' => 'getOneupUploader_Storage_SoundsService',
    ...
    /**
     * Gets the 'app.apprenant.code' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \UserBundle\Services\Code A UserBundle\Services\Code instance
     */
    protected function getApp_Apprenant_CodeService()
    {
        return $this->services['app.apprenant.code'] = new \UserBundle\Services\Code($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'app.form.qcm_exam' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Form\Type\QCMExamType A AppBundle\Form\Type\QCMExamType instance
     */
    protected function getApp_Form_QcmExamService()
    {
        return $this->services['app.form.qcm_exam'] = new \AppBundle\Form\Type\QCMExamType($this->get("doctrine.orm.default_entity_manager")->getRepository("AppBundle:QCM"));
    }

    /**
     * Gets the 'app.form.type.choices_images' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Form\Type\ResponseChoicesType A AppBundle\Form\Type\ResponseChoicesType instance
     */
    protected function getApp_Form_Type_ChoicesImagesService()
    {
        return $this->services['app.form.type.choices_images'] = new \AppBundle\Form\Type\ResponseChoicesType();
    }

    /**
     * Gets the 'app.services.qcm' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Services\QCM A AppBundle\Services\QCM instance
     */
    protected function getApp_Services_QcmService()
    {
        return $this->services['app.services.qcm'] = new \AppBundle\Services\QCM($this->get("doctrine.orm.default_entity_manager")->getRepository("AppBundle:QCM"), $this->get("doctrine.orm.default_entity_manager")->getRepository("AppBundle:Question"));
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Twig\AppTwigExtension A AppBundle\Twig\AppTwigExtension instance
     */
    protected function getApp_Twig_ExtensionService()
    {
        return $this->services['app.twig.extension'] = new \AppBundle\Twig\AppTwigExtension($this->get("doctrine.orm.default_entity_manager"), $this->get("security.token_storage")->getToken());
    }

    /**
     * Gets the 'app.upload_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\EventListener\UploadListener A AppBundle\EventListener\UploadListener instance
     */
    protected function getApp_UploadListenerService()
    {
        return $this->services['app.upload_listener'] = new \AppBundle\EventListener\UploadListener($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'AppBundle', '/app/app/Resources/AppBundle/views', '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'AppBundle', '/app/src/AppBundle/Resources/views', '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'UserBundle', '/app/app/Resources/UserBundle/views', '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'UserBundle', '/app/src/UserBundle/Resources/views', '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('NRf5BkwPhY', 0, 'kGHaOrvJjaW-aqXjTwcvWK', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListenerService('oneup_uploader.post_persist', array(0 => 'app.upload_listener', 1 => 'onUpload'), 0);
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'dev_db_btp', 'port' => NULL, 'dbname' => 'egfbtp_prod', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $c, $f, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => '/app/src/AppBundle/Entity', 1 => '/app/src/UserBundle/Entity'));
        ...
        $d->addCustomDatetimeFunction('day', 'AppBundle\\DQL\\Day');
        $d->addCustomDatetimeFunction('month', 'AppBundle\\DQL\\Month');
        $d->addCustomDatetimeFunction('year', 'AppBundle\\DQL\\Year');
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\Mailer($this->get('swiftmailer.mailer.default'), $this->get('router'), $this->get('templating'), array('confirmation.template' => '@FOSUser/Registration/email.txt.twig', 'resetting.template' => '@FOSUser/Resetting/email.txt.twig', 'from_email' => array('confirmation' => array('contact@passeport-securite-interim-btp.fr' => 'Passeport Securite Interim BTP'), 'resetting' => array('contact@passeport-securite-interim-btp.fr' => 'Passeport Securite Interim BTP'))));
    }
    ...
    protected function getKnpSnappy_ImageService()
    {
        ...
        $a->setTemporaryFolder('/app/app/../web/attestations');
    ...
    {
        $a = new \Knp\Snappy\Pdf('/app/app/../vendor/h4cc/wkhtmltopdf-amd64/bin/wkhtmltopdf-amd64', array('viewport-size' => '‘1024x768’', 'page-size' => 'A4'), array());
        $a->setTemporaryFolder('/app/app/../web/attestations');
    ...
    /**
     * Gets the 'oneup_uploader.controller.attestations' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getOneupUploader_Controller_AttestationsService()
    {
        return $this->services['oneup_uploader.controller.attestations'] = new \Oneup\UploaderBundle\Controller\BlueimpController($this, $this->get('oneup_uploader.storage.attestations'), ${($_ = isset($this->services['oneup_uploader.error_handler.blueimp']) ? $this->services['oneup_uploader.error_handler.blueimp'] : $this->getOneupUploader_ErrorHandler_BlueimpService()) && false ?: '_'}, array('frontend' => 'blueimp', 'storage' => array('directory' => '/app/app/../web/attestations', 'service' => NULL, 'type' => 'filesystem', 'filesystem' => NULL, 'stream_wrapper' => NULL, 'sync_buffer_size' => '100K'), 'custom_frontend' => array('name' => NULL, 'class' => NULL), 'route_prefix' => '', 'allowed_mimetypes' => array(), 'disallowed_mimetypes' => array(), 'error_handler' => NULL, 'max_size' => 9223372036854775807, 'use_orphanage' => false, 'enable_progress' => false, 'enable_cancelation' => false, 'namer' => 'oneup_uploader.namer.uniqid', 'root_folder' => false), 'attestations');
    }

    /**
     * Gets the 'oneup_uploader.controller.images' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Oneup\UploaderBundle\Controller\BlueimpController A Oneup\UploaderBundle\Controller\BlueimpController instance
     */
    protected function getOneupUploader_Controller_ImagesService()
    {
        return $this->services['oneup_uploader.controller.images'] = new \Oneup\UploaderBundle\Controller\BlueimpController($this, $this->get('oneup_uploader.storage.images'), ${($_ = isset($this->services['oneup_uploader.error_handler.blueimp']) ? $this->services['oneup_uploader.error_handler.blueimp'] : $this->getOneupUploader_ErrorHandler_BlueimpService()) && false ?: '_'}, array('frontend' => 'blueimp', 'storage' => array('directory' => '/app/app/../web/images', 'service' => NULL, 'type' => 'filesystem', 'filesystem' => NULL, 'stream_wrapper' => NULL, 'sync_buffer_size' => '100K'), 'custom_frontend' => array('name' => NULL, 'class' => NULL), 'route_prefix' => '', 'allowed_mimetypes' => array(), 'disallowed_mimetypes' => array(), 'error_handler' => NULL, 'max_size' => 9223372036854775807, 'use_orphanage' => false, 'enable_progress' => false, 'enable_cancelation' => false, 'namer' => 'oneup_uploader.namer.uniqid', 'root_folder' => false), 'images');
    }

    /**
     * Gets the 'oneup_uploader.controller.sounds' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Oneup\UploaderBundle\Controller\BlueimpController A Oneup\UploaderBundle\Controller\BlueimpController instance
     */
    protected function getOneupUploader_Controller_SoundsService()
    {
        return $this->services['oneup_uploader.controller.sounds'] = new \Oneup\UploaderBundle\Controller\BlueimpController($this, $this->get('oneup_uploader.storage.sounds'), ${($_ = isset($this->services['oneup_uploader.error_handler.blueimp']) ? $this->services['oneup_uploader.error_handler.blueimp'] : $this->getOneupUploader_ErrorHandler_BlueimpService()) && false ?: '_'}, array('frontend' => 'blueimp', 'storage' => array('directory' => '/app/app/../web/sounds', 'service' => NULL, 'type' => 'filesystem', 'filesystem' => NULL, 'stream_wrapper' => NULL, 'sync_buffer_size' => '100K'), 'custom_frontend' => array('name' => NULL, 'class' => NULL), 'route_prefix' => '', 'allowed_mimetypes' => array(), 'disallowed_mimetypes' => array(), 'error_handler' => NULL, 'max_size' => 9223372036854775807, 'use_orphanage' => false, 'enable_progress' => false, 'enable_cancelation' => false, 'namer' => 'oneup_uploader.namer.uniqid', 'root_folder' => false), 'sounds');
    }
    ...
    {
        return $this->services['oneup_uploader.routing.loader'] = new \Oneup\UploaderBundle\Routing\RouteLoader(array('images' => array(0 => 'oneup_uploader.controller.images', 1 => array('enable_progress' => false, 'enable_cancelation' => false, 'route_prefix' => '')), 'sounds' => array(0 => 'oneup_uploader.controller.sounds', 1 => array('enable_progress' => false, 'enable_cancelation' => false, 'route_prefix' => '')), 'attestations' => array(0 => 'oneup_uploader.controller.attestations', 1 => array('enable_progress' => false, 'enable_cancelation' => false, 'route_prefix' => ''))));
    }

    /**
     * Gets the 'oneup_uploader.storage.attestations' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getOneupUploader_Storage_AttestationsService()
    {
        return $this->services['oneup_uploader.storage.attestations'] = new \Oneup\UploaderBundle\Uploader\Storage\FilesystemStorage('/app/app/../web/attestations');
    }

    /**
     * Gets the 'oneup_uploader.storage.images' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Oneup\UploaderBundle\Uploader\Storage\FilesystemStorage A Oneup\UploaderBundle\Uploader\Storage\FilesystemStorage instance
     */
    protected function getOneupUploader_Storage_ImagesService()
    {
        return $this->services['oneup_uploader.storage.images'] = new \Oneup\UploaderBundle\Uploader\Storage\FilesystemStorage('/app/app/../web/images');
    }

    /**
     * Gets the 'oneup_uploader.storage.sounds' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Oneup\UploaderBundle\Uploader\Storage\FilesystemStorage A Oneup\UploaderBundle\Uploader\Storage\FilesystemStorage instance
     */
    protected function getOneupUploader_Storage_SoundsService()
    {
        return $this->services['oneup_uploader.storage.sounds'] = new \Oneup\UploaderBundle\Uploader\Storage\FilesystemStorage('/app/app/../web/sounds');
    }
    ...
    {
        return $this->services['oneup_uploader.templating.uploader_helper'] = new \Oneup\UploaderBundle\Templating\Helper\UploaderHelper($this->get('router'), array('images' => 52428800, 'sounds' => 52428800, 'attestations' => 52428800));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('^/inscription/confirmed');

        $m = new \Symfony\Component\HttpFoundation\RequestMatcher('^/forgot-password');
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($p, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $c, 1 => new \Symfony\Component\Security\Core\User\InMemoryUserProvider()), 'main', $a, $d, $e), 2 => $r, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $h, ${($_ = isset($this->services['security.authentication.session_strategy']) ? $this->services['security.authentication.session_strategy'] : $this->getSecurity_Authentication_SessionStrategyService()) && false ?: '_'}, $q, 'main', $s, $t, array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $a, $d, $this->get('security.csrf.token_manager')), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '596f7c3ba36dc9.11590188', $a, $h), 5 => new \Symfony\Component\Security\Http\Firewall\SwitchUserListener($b, $c, ${($_ = isset($this->services['security.user_checker']) ? $this->services['security.user_checker'] : $this->getSecurity_UserCheckerService()) && false ?: '_'}, 'main', $i, $a, '_switch_user', 'ROLE_ALLOWED_TO_SWITCH', $d), 6 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $i, $p, $h)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $e, $q, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($g, $q, '/login', false), NULL, NULL, $a, false), new \Symfony\Bundle\SecurityBundle\Security\FirewallConfig('main', 'security.user_checker', 'security.request_matcher.a64d671f18e5575531d76c1d1154fdc4476cb8a79c02ed7a3469178c6d7b96b5ed4e60db', true, false, 'fos_user.user_provider.username_email', 'main', 'security.authentication.form_entry_point.main', NULL, NULL, array(0 => 'logout', 1 => 'switch_user', 2 => 'form_login', 3 => 'anonymous')));
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('/app/app/../var/sessions/prod');
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('00b0d8aef795cf18f6aedfa0ea94cc46');
        $a->setPassword('47bd9a0dde54e18013cfa8511656b0a8');
        $a->setAuthMode(NULL);
    ...
    {
        $this->services['translator.default'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, new \Symfony\Component\Translation\MessageSelector(), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => (__DIR__.'/translations'), 'debug' => true, 'resource_files' => array('af' => array(0 => '/app/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.af.xlf', 1 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.af.yml'), 'ar' => array(0 => '/app/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ar.xlf', 1 => '/app/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ar.xlf', 2 => '/app/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ar.xlf', 3 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.ar.yml', 4 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.ar.yml'), 'az' => array(0 => '/app/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.az.xlf', 1 => '/app/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.az.xlf', 2 => '/app/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.az.xlf'), 'bg' => array(0 => '/app/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.bg.xlf', 1 => '/app/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.bg.xlf', 2 => '/app/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.bg.xlf', 3 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.bg.yml', 4 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.bg.yml'), 'ca' => array(0 => '/app/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ca.xlf', 1 => '/app/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ca.xlf', 2 => '/app/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ca.xlf', 3 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.ca.yml', 4 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.ca.yml'), 'cs' => array(0 => '/app/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.cs.xlf', 1 => '/app/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.cs.xlf', 2 => '/app/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.cs.xlf', 3 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.cs.yml', 4 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.cs.yml'), 'cy' => array(0 => '/app/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.cy.xlf'), 'da' => array(0 => '/app/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.da.xlf', 1 => '/app/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.da.xlf', 2 => '/app/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.da.xlf', 3 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.da.yml', 4 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.da.yml'), 'de' => array(0 => '/app/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.de.xlf', 1 => '/app/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.de.xlf', 2 => '/app/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.de.xlf', 3 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.de.yml', 4 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.de.yml', 5 => '/app/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.de.xliff'), 'el' => array(0 => '/app/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.el.xlf', 1 => '/app/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.el.xlf', 2 => '/app/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.el.xlf', 3 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.el.yml', 4 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.el.yml'), 'en' => array(0 => '/app/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.en.xlf', 1 => '/app/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.en.xlf', 2 => '/app/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.en.xlf', 3 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.en.yml', 4 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.en.yml', 5 => '/app/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.en.xliff', 6 => '/app/vendor/oneup/uploader-bundle/Oneup/UploaderBundle/Resources/translations/OneupUploaderBundle.en.yml'), 'es' => array(0 => '/app/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.es.xlf', 1 => '/app/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.es.xlf', 2 => '/app/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.es.xlf', 3 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.es.yml', 4 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.es.yml', 5 => '/app/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.es.xliff'), 'et' => array(0 => '/app/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.et.xlf', 1 => '/app/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.et.xlf', 2 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.et.yml'), 'eu' => array(0 => '/app/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.eu.xlf', 1 => '/app/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.eu.xlf', 2 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.eu.yml', 3 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.eu.yml'), 'fa' => array(0 => '/app/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.fa.xlf', 1 => '/app/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.fa.xlf', 2 => '/app/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.fa.xlf', 3 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.fa.yml', 4 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.fa.yml'), 'fi' => array(0 => '/app/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.fi.xlf', 1 => '/app/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.fi.xlf', 2 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.fi.yml', 3 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.fi.yml'), 'fr' => array(0 => '/app/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.fr.xlf', 1 => '/app/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.fr.xlf', 2 => '/app/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.fr.xlf', 3 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.fr.yml', 4 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.fr.yml', 5 => '/app/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.fr.xliff', 6 => '/app/app/Resources/translations/FOSUserBundle.fr.yml'), 'gl' => array(0 => '/app/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.gl.xlf', 1 => '/app/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.gl.xlf', 2 => '/app/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.gl.xlf'), 'he' => array(0 => '/app/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.he.xlf', 1 => '/app/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.he.xlf', 2 => '/app/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.he.xlf', 3 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.he.yml', 4 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.he.yml'), 'hr' => array(0 => '/app/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.hr.xlf', 1 => '/app/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.hr.xlf', 2 => '/app/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.hr.xlf', 3 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.hr.yml', 4 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.hr.yml'), 'hu' => array(0 => '/app/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.hu.xlf', 1 => '/app/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.hu.xlf', 2 => '/app/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.hu.xlf', 3 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.hu.yml', 4 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.hu.yml'), 'hy' => array(0 => '/app/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.hy.xlf', 1 => '/app/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.hy.xlf'), 'id' => array(0 => '/app/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.id.xlf', 1 => '/app/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.id.xlf', 2 => '/app/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.id.xlf', 3 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.id.yml', 4 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.id.yml', 5 => '/app/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.id.xliff'), 'it' => array(0 => '/app/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.it.xlf', 1 => '/app/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.it.xlf', 2 => '/app/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.it.xlf', 3 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.it.yml', 4 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.it.yml', 5 => '/app/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.it.xliff'), 'ja' => array(0 => '/app/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ja.xlf', 1 => '/app/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ja.xlf', 2 => '/app/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ja.xlf', 3 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.ja.yml', 4 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.ja.yml'), 'lb' => array(0 => '/app/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.lb.xlf', 1 => '/app/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.lb.xlf', 2 => '/app/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.lb.xlf', 3 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.lb.yml'), 'lt' => array(0 => '/app/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.lt.xlf', 1 => '/app/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.lt.xlf', 2 => '/app/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.lt.xlf', 3 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.lt.yml', 4 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.lt.yml', 5 => '/app/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.lt.xliff'), 'lv' => array(0 => '/app/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.lv.xlf', 1 => '/app/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.lv.xlf', 2 => '/app/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.lv.xlf', 3 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.lv.yml', 4 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.lv.yml'), 'mn' => array(0 => '/app/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.mn.xlf', 1 => '/app/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.mn.xlf'), 'nl' => array(0 => '/app/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.nl.xlf', 1 => '/app/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.nl.xlf', 2 => '/app/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.nl.xlf', 3 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.nl.yml', 4 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.nl.yml', 5 => '/app/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.nl.xliff'), 'nn' => array(0 => '/app/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.nn.xlf'), 'no' => array(0 => '/app/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.no.xlf', 1 => '/app/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.no.xlf', 2 => '/app/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.no.xlf'), 'pl' => array(0 => '/app/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.pl.xlf', 1 => '/app/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.pl.xlf', 2 => '/app/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.pl.xlf', 3 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.pl.yml', 4 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.pl.yml', 5 => '/app/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.pl.xliff'), 'pt' => array(0 => '/app/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.pt.xlf', 1 => '/app/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.pt.xlf', 2 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.pt.yml', 3 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.pt.yml'), 'pt_BR' => array(0 => '/app/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.pt_BR.xlf', 1 => '/app/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.pt_BR.xlf', 2 => '/app/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.pt_BR.xlf', 3 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.pt_BR.yml', 4 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.pt_BR.yml'), 'ro' => array(0 => '/app/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ro.xlf', 1 => '/app/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ro.xlf', 2 => '/app/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ro.xlf', 3 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.ro.yml', 4 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.ro.yml', 5 => '/app/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.ro.xliff'), 'ru' => array(0 => '/app/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ru.xlf', 1 => '/app/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ru.xlf', 2 => '/app/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ru.xlf', 3 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.ru.yml', 4 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.ru.yml', 5 => '/app/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.ru.xliff'), 'sk' => array(0 => '/app/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sk.xlf', 1 => '/app/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sk.xlf', 2 => '/app/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.sk.xlf', 3 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.sk.yml', 4 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.sk.yml'), 'sl' => array(0 => '/app/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sl.xlf', 1 => '/app/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sl.xlf', 2 => '/app/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.sl.xlf', 3 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.sl.yml', 4 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.sl.yml'), 'sq' => array(0 => '/app/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sq.xlf'), 'sr_Cyrl' => array(0 => '/app/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sr_Cyrl.xlf', 1 => '/app/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sr_Cyrl.xlf', 2 => '/app/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.sr_Cyrl.xlf'), 'sr_Latn' => array(0 => '/app/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sr_Latn.xlf', 1 => '/app/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sr_Latn.xlf', 2 => '/app/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.sr_Latn.xlf', 3 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.sr_Latn.yml', 4 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.sr_Latn.yml'), 'sv' => array(0 => '/app/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sv.xlf', 1 => '/app/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sv.xlf', 2 => '/app/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.sv.xlf', 3 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.sv.yml', 4 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.sv.yml'), 'th' => array(0 => '/app/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.th.xlf', 1 => '/app/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.th.xlf', 2 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.th.yml', 3 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.th.yml'), 'tr' => array(0 => '/app/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.tr.xlf', 1 => '/app/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.tr.xlf', 2 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.tr.yml', 3 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.tr.yml'), 'uk' => array(0 => '/app/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.uk.xlf', 1 => '/app/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.uk.xlf', 2 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.uk.yml', 3 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.uk.yml'), 'vi' => array(0 => '/app/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.vi.xlf', 1 => '/app/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.vi.xlf', 2 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.vi.yml', 3 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.vi.yml'), 'zh_CN' => array(0 => '/app/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.zh_CN.xlf', 1 => '/app/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.zh_CN.xlf', 2 => '/app/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.zh_CN.xlf', 3 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.zh_CN.yml', 4 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.zh_CN.yml'), 'zh_TW' => array(0 => '/app/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.zh_TW.xlf'), 'pt_PT' => array(0 => '/app/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.pt_PT.xlf'), 'ua' => array(0 => '/app/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ua.xlf'), 'eo' => array(0 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.eo.yml', 1 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.eo.yml'), 'ky' => array(0 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.ky.yml', 1 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.ky.yml', 2 => '/app/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.ky.xliff'), 'nb' => array(0 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.nb.yml', 1 => '/app/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.nb.yml'), 'sw' => array(0 => '/app/vendor/knplabs/knp-paginator-bundle/Resources/translations/KnpPaginatorBundle.sw.xliff'))), array());
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension(${($_ = isset($this->services['assetic.asset_factory']) ? $this->services['assetic.asset_factory'] : $this->getAssetic_AssetFactoryService()) && false ?: '_'}, $this->get('templating.name_parser'), false, array(), array(0 => 'AppBundle', 1 => 'UserBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
        ...
        $instance->addExtension($this->get('app.twig.extension'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/app/src/UserBundle/Resources/views', 'FOSUser');
        ...
        $instance->addPath('/app/src/UserBundle/Resources/views', 'User');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('9baf686cb11b70fa0848a2e37886d2395f8c46c9');
    }
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('kSxNZbwlGr', 0, 'kGHaOrvJjaW-aqXjTwcvWK', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_USER' => array(0 => 'ROLE_USER'), 'ROLE_VIEWER' => array(0 => 'ROLE_USER'), 'ROLE_BTP' => array(0 => 'ROLE_USER'), 'ROLE_OF' => array(0 => 'ROLE_VIEWER'), 'ROLE_ADMIN' => array(0 => 'ROLE_OF', 1 => 'ROLE_ALLOWED_TO_SWITCH'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_ADMIN')));
    }
        ...
        return array(
            ...
            'kernel.bundles_metadata' => array(
                ...
                'KnpSnappyBundle' => array(
                    'parent' => NULL,
                    'path' => '/app/vendor/knplabs/knp-snappy-bundle',
                ...
                'StofDoctrineExtensionsBundle' => array(
                    'parent' => NULL,
                    'path' => '/app/vendor/stof/doctrine-extensions-bundle',
                ...
                'OneupUploaderBundle' => array(
                    'parent' => NULL,
                    'path' => '/app/vendor/oneup/uploader-bundle/Oneup/UploaderBundle',
                ...
                'UserBundle' => array(
                    ...
                    'path' => '/app/src/UserBundle',
                    'namespace' => 'UserBundle',
                ),
            ),
            'kernel.charset' => 'UTF-8',
            'kernel.container_class' => 'appProdDebugProjectContainer',
            'database_host' => 'dev_db_btp',
            'database_port' => NULL,
            'database_name' => 'egfbtp_prod',
            'database_user' => 'root',
            'database_password' => 'root',
            'mailer_transport' => 'smtp',
            'mailer_host' => 'in-v3.mailjet.com',
            'mailer_user' => '00b0d8aef795cf18f6aedfa0ea94cc46',
            'mailer_password' => '47bd9a0dde54e18013cfa8511656b0a8',
            'mailer_port' => 587,
            'secret' => '9baf686cb11b70fa0848a2e37886d2395f8c46c9',
            'locale' => 'fr',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '9baf686cb11b70fa0848a2e37886d2395f8c46c9',
            ...
            'session.save_path' => '/app/app/../var/sessions/prod',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => '00b0d8aef795cf18f6aedfa0ea94cc46',
            'swiftmailer.mailer.default.transport.smtp.password' => '47bd9a0dde54e18013cfa8511656b0a8',
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'contact@passeport-securite-interim-btp.fr' => 'Passeport Securite Interim BTP',
            ),
            ...
            'knp_snappy.pdf.binary' => '/app/app/../vendor/h4cc/wkhtmltopdf-amd64/bin/wkhtmltopdf-amd64',
            ...
            'oneup_uploader.config.images' => array(
                'frontend' => 'blueimp',
                'storage' => array(
                    'directory' => '/app/app/../web/images',
                    'service' => NULL,
                    'type' => 'filesystem',
                    'filesystem' => NULL,
                    'stream_wrapper' => NULL,
            ...
            'oneup_uploader.config.sounds' => array(
                'frontend' => 'blueimp',
                'storage' => array(
                    'directory' => '/app/app/../web/sounds',
                    'service' => NULL,
                    'type' => 'filesystem',
                    'filesystem' => NULL,
                    'stream_wrapper' => NULL,
            ...
            'oneup_uploader.config.attestations' => array(
                'frontend' => 'blueimp',
                'storage' => array(
                    'directory' => '/app/app/../web/attestations',
                    'service' => NULL,
                    'type' => 'filesystem',
                    'filesystem' => NULL,
                    'stream_wrapper' => NULL,
            ...
            'oneup_uploader.controllers' => array(
                'images' => array(
                    0 => 'oneup_uploader.controller.images',
                    1 => array(
                        'enable_progress' => false,
                        'enable_cancelation' => false,
                        'route_prefix' => '',
                ...
                'sounds' => array(
                    0 => 'oneup_uploader.controller.sounds',
                    1 => array(
                        'enable_progress' => false,
                        'enable_cancelation' => false,
                        'route_prefix' => '',
                ...
                'attestations' => array(
                    0 => 'oneup_uploader.controller.attestations',
                    1 => array(
                        'enable_progress' => false,
                        'enable_cancelation' => false,
                        'route_prefix' => '',
