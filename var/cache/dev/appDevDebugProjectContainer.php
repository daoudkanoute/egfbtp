...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('cFFhcPbw0Q', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('XgzhPSb9TH', 0, 'rIU6jzbZWb7Qnlgnsn49Bu', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_c4aaa7a2d76209f3a53f66e548f5bbee39be586abd6c7c78d9283ff86343a0f9');
    ...
    protected function getKnpSnappy_ImageService()
    {
        ...
        $a->setTemporaryFolder(($this->targetDirs[3].'/app/../web/attestations'));
    ...
    {
        $a = new \Knp\Snappy\Pdf(($this->targetDirs[3].'/app/../vendor/h4cc/wkhtmltopdf-amd64/bin/wkhtmltopdf-amd64'), array('viewport-size' => '‘1024x768’', 'page-size' => 'A4'), array());
        $a->setTemporaryFolder(($this->targetDirs[3].'/app/../web/attestations'));
    ...
    {
        return $this->services['oneup_uploader.storage.attestations'] = new \Oneup\UploaderBundle\Uploader\Storage\FilesystemStorage(($this->targetDirs[3].'/app/../web/attestations'));
    }
    ...
    {
        return $this->services['oneup_uploader.storage.images'] = new \Oneup\UploaderBundle\Uploader\Storage\FilesystemStorage(($this->targetDirs[3].'/app/../web/images'));
    }
    ...
    {
        return $this->services['oneup_uploader.storage.sounds'] = new \Oneup\UploaderBundle\Uploader\Storage\FilesystemStorage(($this->targetDirs[3].'/app/../web/sounds'));
    }
    ...
    {
        return $this->services['oneup_uploader.templating.uploader_helper'] = new \Oneup\UploaderBundle\Templating\Helper\UploaderHelper($this->get('router'), array('images' => 2097152, 'sounds' => 2097152, 'attestations' => 2097152));
    }
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('4hws7rJ4O0', 0, 'rIU6jzbZWb7Qnlgnsn49Bu', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    private $loadedDynamicParameters = array(
        ...
        'oneup_uploader.config.images' => false,
        'oneup_uploader.config.sounds' => false,
        'oneup_uploader.config.attestations' => false,
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'oneup_uploader.config.images': $value = array(
                'frontend' => 'blueimp',
                'storage' => array(
                    'directory' => ($this->targetDirs[3].'/app/../web/images'),
                    'service' => NULL,
                    'type' => 'filesystem',
                    'filesystem' => NULL,
                    'stream_wrapper' => NULL,
            ...
            case 'oneup_uploader.config.sounds': $value = array(
                'frontend' => 'blueimp',
                'storage' => array(
                    'directory' => ($this->targetDirs[3].'/app/../web/sounds'),
                    'service' => NULL,
                    'type' => 'filesystem',
                    'filesystem' => NULL,
                    'stream_wrapper' => NULL,
            ...
            case 'oneup_uploader.config.attestations': $value = array(
                'frontend' => 'blueimp',
                'storage' => array(
                    'directory' => ($this->targetDirs[3].'/app/../web/attestations'),
                    'service' => NULL,
                    'type' => 'filesystem',
                    'filesystem' => NULL,
                    'stream_wrapper' => NULL,
